...
export default function Sponsor() {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full flex justify-center">
        <img width="80%" src="/sponsors/grupotesta/Grupotesta.gif" className="mb-10" alt="Sponsor GIF 3"/>
      </div>
      <div className="w-full flex justify-center">
        <img width="80%" src="/sponsors/gentilucci/Gentilucci.gif" className="mb-10" alt="Sponsor GIF 3"/>
      </div>
